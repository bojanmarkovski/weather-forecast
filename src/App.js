...
const API_key = '245b97bfbe229279da08bb5dd4ef08f1'
// app call api.openweathermap.org/data/2.5/weather?q=London,uk
  ...
  get_Weather_icon(icons, rangeId){
    switch(true){
      case rangeId >= 200 && rangeId <= 232:
        this.setState({icon: this.weatherIcon.Thunderdstorm})
        break;
